...
async function greet() {
    console.clear();
    const rainboxTitle = chalkAnimation.rainbow("Hassam's currency converter PIAIC(PIAIC202061)\n");
    await sleep();
    rainboxTitle.stop();
}
async function main(to, from, amount) {
